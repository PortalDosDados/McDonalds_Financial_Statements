...
Este repositório contém um notebook e scaffold para processar os demonstrativos financeiros do McDonald's (2002-2022).
...
- O script `scripts/download_data.ps1` usa a CLI `kaggle`. Se preferir, use `kaggle datasets download -d mikhail1681/mcdonalds-financial-statements-2002-2022 -p data --unzip` manualmente.
